---
description: "Create a new linalg demo frontend scaffold under demos/<demo-name>/frontend"
---

Create a new demo named: <demo-name>
...
- Do NOT touch other demos unless asked
